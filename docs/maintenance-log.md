...
## 2026-09-13：删除“AI学习”分类

- 按用户要求删除“AI学习”分类下唯一文章《AI 知识自测：61 个主题的五阶段路线图》，原永久链接为 `/posts/workbuddy-ai-quiz-roadmap/`。
- 分类由文章数据自动生成；删除唯一文章后 `/categories/AI学习/` 不再构建。
- 已同步更新 WorkBuddy 每日任务，永久忽略原来源 `2026-09-10-16-31-14/ai-quiz/output/题库总览.html`，防止同一内容和分类被自动重新导入。
- 其他 AI 新闻、每日新闻、历史和 GitHub 高分项目文章不受影响。
